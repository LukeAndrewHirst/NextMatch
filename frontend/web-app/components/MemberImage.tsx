  ...
  return (
    <div className='cursor-pointer' onClick={onOpen}>
        {photo?.publicId ? (
                ...
                gravity='faces' className={clsx('rounded-2xl', {'opacity-40': !photo.isApproved && role != 'ADMIN'})} priority />
        ...
        <AppModal imageModal={true} isOpen={isOpen} onClose={onClose} body={
            <>
                {photo?.publicId ? (
                <CldImage alt='Image of member' src={photo.publicId} width={750} height={750} className={clsx('rounded-2xl', {'opacity-40': !photo.isApproved && role != 'ADMIN'})} priority />
